...
program
    ...
    .option('--exclude-pattern <regex>', 'Exclude packages matching regex (can be repeated)', (val, prev) => [...prev, val], [])
...
async function main() {
    try {
        ...
        console.log(output);
        const exitCode = checker.getExitCode(violations, totalChecked);
